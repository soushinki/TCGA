...
def launch():
    """
    Shows a wizard-style menu to configure and launch a Shadowverse game.
    """
    ...
    try:
        ...
        if confirm:
            ...
            # This is a simplified run_simulation call, directly from here
            ...
            game_engine = SvEngine(game_mode=mode)
